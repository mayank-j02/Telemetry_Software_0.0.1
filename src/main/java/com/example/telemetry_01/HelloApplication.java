...
//import eu.hansolo.medusa.Gauge; //Import the jar file of Medusa for gauges.
import javafx.application.Application;
...
//    Scene scene = new Scene(layout);
    ...
    Gauge gauge5 = GaugeBuilder.create()
            ...
            .build();
    //    Gauge digital_gauge = GaugeBuilder.create()
...
//            .customTickLabels("0", "1", "2", "3", "4", "5", "6", "7", "8")
//            .build();
...
//        digital_gauge.setValue(3);
        ...
        gauge8.setMaxValue(1300.00);
        gauge8.setTickLabelsVisible(false);
        gauge8.setMinorTickMarksVisible(false);

        gauge9.setTitle("TPS");
        gauge9.setMinValue(0.00);
        gauge9.setMaxValue(1300.00);
        ...
        gauge11.setTitle("FPS");
        gauge11.setMinValue(0.00);
        gauge11.setMaxValue(1300.00);
...
//        gridpane3.setBackground(new Background(new BackgroundFill(Color.valueOf("#1c1d1f"), CornerRadii.EMPTY, Insets.EMPTY))); //Set the background colour as dark grey.
...
//                            int tps_total = ((tps_1 * 256) + tps_2);
//                            Platform.runLater(() -> {
//                                gauge9.setValue(tps_total);
//                                shiftSeriesData2((float) tps_total);
//                            });
//                        }
//
//                        if (id == 4) {
...
//                            int tps_7 = b[3] & 0xFF;
//                            int tps_8 = b[2] & 0xFF;
//                            int h = ((tps_7 * 256) + tps_8);
//                            Platform.runLater(() -> {
//                                digital_gauge.setValue(h);
////                                shiftSeriesData2((float) tps_total);
//                            });
//                        }
//
